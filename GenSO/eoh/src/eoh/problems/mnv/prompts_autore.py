...
class GetPrompts:
    ...
    def __init__(self):
        ...
        self.problem_description = (
            ...
            "Demand $d_{t}$ follows an autoregressive process of order 4, with 95% dependence on the previous 1 ~ 4 "
            "periods (uniform weights), additive noise with standard deviation 50, and a long-term mean of 1000:"
            "d_{t} = 1000 * (1 - 0.95) + 0.95 * frac{1}{L} \sum_{l=1}^{L} (d_{s,t-h} - 1000) + \epsilon_t, L = 1,2,3,4\n"
